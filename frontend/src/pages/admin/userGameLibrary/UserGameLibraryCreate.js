...
const UserGameLibraryCreate = () => {
    ...
    useEffect(() => {
        // Load user dan game untuk dropdown
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://127.0.0.1:8000/api/user_game_library", formData)
            .then(() => {
    ...
    return (
        <div className="container-fluid">
            <h1 className="h3 mb-4 text-gray-800">Tambah User Game Library</h1>
...
export default UserGameLibraryCreate;
